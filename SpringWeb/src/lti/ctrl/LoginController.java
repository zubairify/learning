...
public class LoginController {
	...
	public String checkLogin(LoginBean login, Map map) {
		if(login.getEmail().equals("duke@java.com") && 
				login.getPassword().equals("java")) {
			// Login successful
			map.put("Greeting", "Welcome " + login.getEmail());
			return "welcome";
		} else {
			// Login failed
			map.put("Invalid", "Email ID/Password does not match");
			return "home";
		}
	}
	...
	/*public ModelAndView checkLogin(LoginBean login) {
		...
		if(login.getEmail().equals("duke@java.com") && 
			...
			// Login failed
			mav.addObject("Invalid", "Email ID/Password does not match");
